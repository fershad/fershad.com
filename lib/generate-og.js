...
const ogFontPath = fileURLToPath(
  new URL("./DepartureMono-Regular.otf", import.meta.url),
);
...
function createImage(image) {
  ...
  registerFont(ogFontPath, { family: "OG Font", weight: "700" });
...
function drawTitleBlock(ctx, width, height, title) {
  ...
  ctx.font = `700 ${fontSize}px "OG Font", sans-serif`;
